...
let right_tree(tree : 'a t_234tree) : 'a t_234tree =
  ...
  | _ -> failwith "error unknown tree l 545"
;;
...
let rec t234_highest_value (tree : 'a t_234tree) : 'a =
  ...
  then failwith "error empty tree"
    ...
    then
      ...
      | _ -> failwith "error unknown tree l558"
                        ...
                        | FOUR_ROOT(rv1,rv2,rv3,_,_,_,_) ->
                           two_rooting(rv1,
                                       ...
                                       three_rooting(rv2,
                                                     ...
                                                     empty_234tree(),
                                                     empty_234tree()))
                        | _ -> failwith "error unknown tree l599"
                      )
                   ...
                   then (*Si le p̬re est un 2-noeud et que ses fils sont des feuilles*)
                     ...
                     | TWO_ROOT(rv,_,_) ->
                        (
                          ...
                          | _ -> failwith "error unknown tree l659"
                        )
                   ...
                   (
                     ...
                     | TWO_ROOT(lv,_,_) ->
                        (
                          ...
                          | _ -> failwith "error unknown tree l725"
                        )
                     | THREE_ROOT(lv1,lv2,_,_,_) ->
                        (
                          if lv1 = value
                   ...
                   then
                     ...
                     | TWO_ROOT(mv,_,_) ->
                        (
                          ...
                          | _ -> failwith "error unknown tree l782"
                        )
                     | THREE_ROOT(mv1,mv2,_,_,_) ->
                        (
                          if mv1 = value
                     ...
                     | _ -> failwith "error unknown tree l809"
                     ...
                     then
                       ...
                       | TWO_ROOT(rv,_,_) ->
                          (
                            ...
                            | _ -> failwith "error unknown tree l837"
                          )
                       | THREE_ROOT(rv1,rv2,_,_,_) ->
                          (
                            if rv1 = value
                       ...
                       | _ -> failwith "error unknown tree l864"
                   ...
                   (
                     ...
                     | TWO_ROOT(lv,_,_) ->
                        (
                          ...
                          | _ -> failwith "error unknown tree l908"
                        )
                     | THREE_ROOT(lv1,lv2,_,_,_) ->
                        (
                          if lv1 = value
                   ...
                   then
                     ...
                     | TWO_ROOT(mlv,_,_) ->
                        (
                          ...
                          | _ -> failwith "error unknown tree l965"
                        )
                     | THREE_ROOT(mlv1,mlv2,_,_,_) ->
                        (
                          if mlv1 = value
                     ...
                     | _ -> failwith "error unknown tree l992"
                   ...
                   (
                     ...
                     | TWO_ROOT(mrv,_,_) ->
                        (
                          ...
                          | _ -> failwith "error unknown tree l1021"
                        )
                       ...
                       then
                         ...
                         | TWO_ROOT(rv,_,_) ->
                            (
                              ...
                              | _ -> failwith "error unknown tree l1078"
                            )
                         | THREE_ROOT(rv1,rv2,_,_,_) ->
                            (
                              if rv1 = value
                         ...
                         | _ -> failwith "error unknown tree l1105"
